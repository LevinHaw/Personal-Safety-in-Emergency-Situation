...
import com.example.pses.Contacts.CustomAdapter;
import com.example.pses.Contacts.DbHelper;
import com.example.pses.ShakeServices.ReactivateService;
import com.example.pses.ShakeServices.SensorService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(db.count()!=5) {
                    ...
                    Toast.makeText(EmergencyMessage.this, "Can't Add more than 5 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EmergencyMessage.this, BottomNav.class));
            }
        });
    }
